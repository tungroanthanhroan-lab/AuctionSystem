 ...
 *
 * FIX BUG 4: Bỏ "implements AuctionObserver" — Notifier KHÔNG phải Observer.
 *            Notifier là subject/publisher trong Observer Pattern.
 *
 * FIX BUG 10: Thay new Thread() bằng ExecutorService có giới hạn thread pool
...
public class AuctionNotifier {
    ...
    public void shutdown() {
        ...
        System.out.println("[Notifier] Đã đóng broadcast pool.");
    }

    // ── Giữ tên cũ (addObserve/removeObserve) làm alias để tránh break code cũ ──
